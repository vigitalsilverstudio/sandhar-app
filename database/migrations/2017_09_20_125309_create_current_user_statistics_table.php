...
class CreateCurrentUserStatisticsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('current_user_statistics', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('current_user_statistics');
    }
}
