...
class SaveAllStatisticsController extends Controller{
    
	public function save_all_statistics_autoliv(){
		...
		$autoliv_statistics = Statistic::where('company_name', 'autoliv')->get($autoliv_only);
		
        $autoliv_statistics_header = [
            'ID',
            'Nazwa produktu',
            'ID produktu',
            'Nazwa firmy',            
        ...
        $response = SaveAsToExcel::save_as_to_excel('Statystyki Autoliv', 'Statystyki autoliv', $autoliv_statistics, $autoliv_statistics_header);		
	}
	
	public function save_all_statistics_trw(){
		$trw_only = [
			'id',
			'product_name',
			'product_id',
		...
		$trw_statistics = Statistic::where('company_name', 'trw')->get($trw_only);
		
        $trw_statistics_header = [
            'ID',
            'Nazwa produktu',
            'ID produktu',
            'Nazwa firmy',            
        ...
        $response = SaveAsToExcel::save_as_to_excel('Statystyki Trw', 'Statystyki trw', $trw_statistics, $trw_statistics_header);
	}
}
